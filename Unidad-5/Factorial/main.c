...
// método recursivo que calcule la suma de un arreglo de numeros enteros
...
void mostrarHasta(int n)
 {  caso base  y se va a repetir hasta que el número sea un 0.
    ...
    //caso general
    printf("%d, ", n); // muestra el 8 ........ muestra el 7
    mostrarHasta(n-1); // vuelve a entrar con 8-1 ........... vuelve a entrar con 7-1
    // Si ponés el printf acá, va de 1 2 3 4 5 6 7 8
